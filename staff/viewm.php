...
<div class='dashboard-app'>
        ...
        <div class='dashboard-content'>
            ...
            <h1 style="text-align:center;padding-top: 50px;">New Tokens</h1>
...
<div class="form-group" style="padding: 10px;" >
 ...
 ?>
  ...
  <tr>
    ...
    <td>
    <a href="service.php?id=<?php echo $row['id'];?>"><button style="background-color:green; color: black;border-radius: 5px;margin-left: 10px; ">Service</button></a>
  </td>
    </tr>

...
header("Content-type: application/vnd.ms-excel");
  header("Content-Disposition: attachment; filename=Unregistered_Managers.xls" );
  header("Expires: 0");
...
<table>
  ...
  <tbody>
    <?php
    $qryreport = mysqli_query($conn,"SELECT * from manager_cred where status=0 AND role='MG'") or die(mysqli_error());

...
<?php
 $sql = "SELECT * FROM `manager_cred` WHERE role = 'MG' AND status=1";
 ...
 <table class="center" style="text-align:center;">
  ...
  <button type="submit" class="btn btn-primary" name="submit" style="background-color: #ff3333; color: white;" onclick="window.location.href = 'showdem.php';" > Inactive Managers </button>

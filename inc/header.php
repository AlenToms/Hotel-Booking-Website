          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input name="name" type="text" id="fname" class="form-control shadow-none" octavalidate="R" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label" for="email">Email</label>
                <input name="email" type="email" id="email" class="form-control shadow-none" octavalidate="R" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label" for="num">Phone Number</label>
                <input name="phonenum" type="text" pattern="[6-9]{1}[0-9]{9}" minlength="10" maxlength="10" id="num" name="phone" class="form-control shadow-none" octavalidate="R" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label" for="pic">Picture</label>
                <input name="profile" type="file" id="pic" accept=".jpg, .jpeg, .png, .webp" class="form-control shadow-none" octavalidate="R" required>
              </div>
              ...
              <div class="col-md-12 mb-3">
                ...
                <textarea name="address" id="addr" class="form-control shadow-none" rows="1" octavalidate="R" required></textarea>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label" for="pin">Pincode</label>
                <input name="pincode" type="text" pattern="[0-9]{6}" minlength="6" maxlength="6" id="pin" class="form-control shadow-none" octavalidate="R" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label" for="dob">Date of birth</label>
                <input name="dob" type="date" id="dob" max="2004-10-27" class="form-control shadow-none" octavalidate="R" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label" for="pass">Password</label>
                <input name="pass" type="password" id="pass" class="form-control shadow-none" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label" for="cpass">Confirm Password</label>
                <input name="cpass" type="password" id="cpass" class="form-control shadow-none" required>
              </div>
            </div>
          </div>

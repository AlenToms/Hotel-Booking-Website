<?php
	...
	define('PAYTM_MERCHANT_KEY', 'MaVVFA52889151440058	'); //Change this constant's value with Merchant key received from Paytm.
	define('PAYTM_MERCHANT_MID', 'K&S@cZNQ0795eK@V'); //Change this constant's value with MID (Merchant ID) received from Paytm.

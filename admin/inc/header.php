...
<div class="col-lg-2 bg-dark border-top border-3 border-secondary" id="dashboard-menu">
  <nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid flex-lg-column align-items-stretch">
      <h4 class="mt-2 text-light">Manager PANEL</h4>
        ...
        <ul class="nav nav-pills flex-column">
          ...
          <li class="nav-item">
            ...
            <div class="collapse show px-3 small mb-1" id="bookingLinks">
              <ul class="nav nav-pills flex-column rounded border border-secondary">
              <li class="nav-item">
                  <a class="nav-link text-white" href="staff_view.php">View Staff</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="staff_leave.php">Leave</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="add_staff.php">Add New</a>
                </li>
              </ul>
            </div>
          </li>
